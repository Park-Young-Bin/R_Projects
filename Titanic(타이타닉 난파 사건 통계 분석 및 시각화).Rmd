...
---
## 타이타닉 난파 사건 통계 분석 및 시각화
이번의 분석에서는 총 4가지의 분석과 시각화를 진행해 보았다.

1. 연령대별 생존율
2. 티켓 등급에 따른 생존율
3. 티켓등급별 성별에 따른 생존여부
4. 탑승한 부모/자녀 수에 따라 생존여부
...
탑승한 부모/자녀 수에 따른 생존자 수를 확인해 보면 0명인 경우가 사망자수가 많고, 1, 2명인 경우에는 생존자 수가 조금 더 많다고 할 수 있다.
```{r}
max(full$Parch)
min(full$Parch)
